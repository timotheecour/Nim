...
const
  ...
  procPragmas* = routinePragmas + declPragmas + {FirstCallConv..LastCallConv,
  ...
  macroPragmas* = routinePragmas + declPragmas + {FirstCallConv..LastCallConv,
    wMagic, wNoSideEffect, wCompilerProc, wNonReloadable, wCore,
    wDiscardable, wGensym, wInject, wDelegator}
  iteratorPragmas* = routinePragmas + declPragmas + {FirstCallConv..LastCallConv, wNoSideEffect, wSideEffect,
    wMagic, wBorrow,
